...
lonMin, lonMax = North_lonmin, North_lonmax
latMin, latMax = North_latmin, North_latmax
...
years = np.arange(1998,2024)  # 1998-2023
for yy in years:
    # Load IMERG data
    ...
    print("Elapsed time for processing one year of IMERG data:", end - start, "seconds")
...
IMERGClimoMean.to_netcdf('/huracan/tank4/cornell/ORCESTRA/imerg/imerg_campaign_climo_1998_2023_north.nc')
...
#zonalmean_precip.to_netcdf('/huracan/tank4/cornell/ORCESTRA/imerg/imerg_zonalmean_precip_1998_2023_north.nc')
