...
prec_alongtrack = xr.DataArray(prec_alongtrack, coords=[years, ship_time_interp], dims=['year', 'time'])
...
prec_alongtrack_ds.attrs['history'] = 'Created 2025-06-25 by Allison Wing'
